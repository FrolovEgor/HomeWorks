...
namespace HomeWork_5_4
{
    class Program
    {
        ...
        static string SearchProgression(double[] initialMass) 
        {
            ...
            //f (Summ == likeArephmiticSumm) return result = "Данный массив чисел содержит арифметическую прогрессию";   //Проверка равна ли сумма масива сумме арифметической прогресии
        ...
        {
            double[] startMass= { 2, 3};             //Инициализация массива содержащего последовательность
